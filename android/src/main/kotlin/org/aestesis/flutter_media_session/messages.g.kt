...
enum class MediaCommand(
    ...
    companion object {
        fun ofRaw(raw: Int): MediaCommand? = values().firstOrNull { it.raw == raw }
    }
}

//
// //////////////////////////////////////////////////////////////////////////////////////////////////// */
enum class MediaRepeatType(
    val raw: Int,
) {
    NONE(0),
    ONE(1),
    ...
    companion object {
        fun ofRaw(raw: Int): MediaRepeatType? = values().firstOrNull { it.raw == raw }
    }
}

enum class MediaShuffleType(
    val raw: Int,
) {
    NONE(0),
    ITEMS(1),
    ...
    companion object {
        fun ofRaw(raw: Int): MediaShuffleType? = values().firstOrNull { it.raw == raw }
    }
}
...
class MediaNotificationHandler(
    ...
    companion object {
        /** The codec used by MediaNotificationHandler. */
        val codec: MessageCodec<Any?> by lazy {
            messagesPigeonCodec()
        }
    }
    ...
    fun notify(
        notificationArg: MediaNotification,
        callback: (Result<Unit>) -> Unit,
    ) {
        val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
        val channelName = "dev.flutter.pigeon.flutter_media_session.MediaNotificationHandler.notify$separatedMessageChannelSuffix"
