 ...
 */
class MediaNotificationHandler(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  companion object {
...
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.flutter_media_session.MediaNotificationHandler.notification$separatedMessageChannelSuffix"
